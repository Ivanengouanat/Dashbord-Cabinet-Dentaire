...
const AddPersonnel = (props) => {
  const { handleAddPersonnel, initialPersonnel } = props;
  ...
  const initialValues = initialPersonnel || {
    noms: "",
    prenoms: "",
    sexe: "",
    age: "",
  ...
  const contactValid = /^(((67|69|)+[0-9]{7})|(((65)+[0-9])+[0-9]{7}))$/;
  ...
  const userSchema = yup.object().shape({
    ...
    prenoms: yup.string().required("ce champ doit être rempli"),
    age: yup
      .string()
    ...
    sexe: yup
      .string()
      .oneOf(["Masculin", "Feminin"], "Veuillez choisir un sexe valide.")
      .required("Ce champ est requis."),
    poste: yup
      .string()
      .oneOf(["Docteur", "Secretaire", "CM"], "Poste non valide.")
      .required("Ce champ est requis."),
    contact: yup
      .string()
  ...
  return (
    <Box m="20px">
      <Headers title="Ajouter Personnel" subtitle="information du Personnel" />

      <Formik
        key={initialPersonnel ? initialPersonnel.id : "new"} // chaque fois que l'utilisateur bascule entre "édition" et "ajout", Formik recrée un nouvel état interne, forçant le formulaire à se réinitialiser en fonction des nouvelles valeurs initiales.
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              ...
              >
                ...
                <option value="CM">Commuity Manager</option>
              </TextField>
              <TextField
                fullWidth
                variant="filled"
