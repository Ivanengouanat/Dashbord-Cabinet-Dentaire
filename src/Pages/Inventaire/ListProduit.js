...
const ListProduit = ({
  ...
  const handleConfirmDelete = () => {
    if (selectedProduitId) {
      handleDeleteProduit(selectedProduitId);
    }
    handleCloseDialog();
  };
    ...
    },
    {
      ...
      renderCell: (params) => {
        ...
        return (
          ...
          >
            {row.categorie === "commercial" && (
              <AttachMoneyIcon sx={{ height: "20px", width: "20px" }} />
            )}
            {row.categorie === "non Commercial" && (
